...
import kr.co.toyappfactory.gosung.menu.NewsFeed;
...
public class Post extends AppCompatActivity {
    ...
    private void addPicButton(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(Post.this);
        ...
        if (uploadButton != null) {
            uploadButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    imageViewBitmap.compress(Bitmap.CompressFormat.JPEG, 70, stream);
                    byte[] bytes = stream.toByteArray();

                    Intent intent = new Intent(Post.this, ProductInfo.class);
                    intent.putExtra("bitmapByteArray", bytes);
    ...
    public void onActivityResult(int reqCode, int resCode, Intent data) {
        ...
        if (resCode == Activity.RESULT_OK) {
            if (reqCode == REQUEST_CAMERA) {
                ...
                uploadPic = (ImageView)findViewById(R.id.imageview_pic);
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            byte[] bytes = savedInstanceState.getByteArray("imageByteArray");
            if(bytes != null){
                imageViewBitmap = BitmapFactory.decodeByteArray(bytes, 0, bytes.length);
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        if(imageViewBitmap != null){
            ...
            savedInstanceState.putByteArray("imageByteArray", bytes);
    ...
    private void upload() {
        ...
        if(imageList.size() <= 0 && postEditText.getText().toString().isEmpty()){
            return;
        }
        ...
        Call<PostResponse> call = apiService.uploadPost(uniqueId, userId, name, hashTagsArray, hashTagsArray.size(), post, map);
