...
public class TermsOfUse extends AppCompatActivity {
    ...
    String termsOfUse = "모비딕 서비스 이용약관\n" +
            "\n" +
            "[현행] 2016년 8월 1일 시행안\n" +
            "제 1 조 (목적)\n" +
            "\n" +
            "이 약관은 브랜드 리서치(이하 \"회사”라 합니다)가 제공하는 모비딕 서비스(이하 \"서비스”라 합니다)와 관련하여, 회사와 이용 고객간에 서비스의 이용조건 및 절차, 회사와 회원간의 권리, 의무 및 기타 필요한 사항을 규정함을 목적으로 합니다. 본 약관은 PC통신, 스마트폰(안드로이드폰, 아이폰 등) 앱 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 준용됩니다. \n" +
            "\n" +
            "제 2 조 (용어의 정의)\n" +
            "\n" +
            "1. “사이트”란 브랜드 순위를 “이용자”에게 제공하기 위하여, “회사”가 컴퓨터 등 정보통신설비를 이용하여 서비스를 제공하는 가상의 영업장을 말합니다. \n" +
            "2. “회원”이라 함은 “모비딕”에 개인정보를 제공하여 회원등록을 한 자로서, “모비딕”의 정보를 지속적으로 제공받으며, “모비딕”이 제공하는 서비스를 계속적으로 이용할 수 있는 자를 의미하고, “모비딕” 광고업소는 포함되지 않습니다. \n" +
            ...
            "제 3 조 (약관의 명시와 개정)\n" +
            " \n" +
            "1. “회사”는 『전자상거래 등에서의 소비자보호에 관한 법률』, 『약관의 규제등에 관한 법률』, 『전자문서 및 전자거래기본법』, 『전자서명법』, 『정보통신망 이용촉진 등에 관한 법률』, 『소비자기본법』 등 관련법령을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다. \n" +
            "2. “회사”는 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 “사이트”의 초기화면에 그 적용일자 7일 이전부터 적용일자 전일까지 공지합니다. 다만, “이용자”에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 “회사”는 개정 전과 개정 후 내용을 “이용자”가 알기 쉽도록 표시합니다. \n" +
            "3. “회원”은 변경된 약관에 동의하지 않을 권리가 있으며, 변경된 약관에 동의하지 않을 경우에는 서비스 이용을 중단하고 탈퇴를 요청할 수 있습니다. 다만, “이용자”가 제3항의 방법 등으로 “회사”가 별도 고지한 약관 개정 공지 기간 내에 “회사”에 개정 약관에 동의하지 않는다는 명시적인 의사표시를 하지 않는 경우 변경된 약관에 동의한 것으로 간주합니다. \n" +
            "4. 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 『전자상거래 등에서의 소비자보호에 관한 법률』, 『약관의 규제 등에 관한 법률』, 공정거래위원회가 정하는 『전자상거래 등에서의 소비자보호지침』 및 관계 법령 또는 상관례에 따릅니다. \n" +
            "\n" +
            "제 4 조 (관련법령과의 관계)\n" +
            "\n" +
            ...
            "3. “서비스”의 내용, 이용방법, 이용시간에 대하여 변경 또는 “서비스” 중단이 있는 경우에는 변경 또는 중단될 “서비스”의 내용 및 사유와 일자 등은 그 변경 또는 중단 전에 “회원”이 충분이 인지할 수 있는 방법으로 사전에 공지합니다. \n" +
            "\n" +
            "제 6 조 (서비스 이용시간 및 중단)\n" +
            "\n" +
            ...
            "\t9) 허위 리뷰작성 등을 통해 서비스를 부정한 목적으로 이용하는 행위 \n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textview = (TextView) findViewById(R.id.textview_terms_of_use);
        textview.setText(termsOfUse);

        String title = getResources().getString(R.string.termsofuse);
